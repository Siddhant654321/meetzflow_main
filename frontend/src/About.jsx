...
const About = () => {
  ...
  const handleClick = async (e) => {
    ...
    if (inputState.confirmPassword !== inputState.password) {
      inputErrors = {
        ...inputErrors,
        confirmPasswordError: "Confirm Password should be the same as password",
      };
    } else {
    ...
    if (
      ...
      try {
        ...
        await axios.patch("/account/endpoint/update", data, {
  ...
  const logoutFromAll = async () => {
    try {
      ...
      await axios.get("/account/endpoint/logout-everyone", {
        withCredentials: true,
      });
      localStorage.clear();
      navigate("/");
  ...
  return (
    <div className="main-div">
      <div className="main-container container-fluid">
        ...
        >
          <i className="bi bi-three-dots-vertical chat-menu-icon"></i>
        </button>
        <AlertPopup
          body={popupBody}
          header="Your Account"
          showPopup={showMenuPopup}
          setShowPopup={setShowMenuPopup}
        />
        <AlertPopup
          body={userError}
          header="Error"
        ...
        <div className="img-container rounded-circle">
          ...
          <div
            className="edit-image col-12 rounded-circle"
